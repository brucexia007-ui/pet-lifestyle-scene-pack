...
根据同一只猫或狗的 3–8 张照片、名字、用户明确提供的性别、性格与期望场景，生成身份与个性一致的柔和生活写真。支持十三个预设场景、健身等自定义场景、单图修复，以及 Codex、Kimi Code、Claude Code 和 WorkBuddy。
...
https://raw.githubusercontent.com/brucexia007-ui/pet-lifestyle-scene-pack/v1.2.0/AGENT_BOOTSTRAP.md
...
更完整的可复制模板见 [START_HERE.zh-CN.md](START_HERE.zh-CN.md)。智能体会先锁定宠物身份与性格，生成一张校准预览；确认后，每个场景单独生成一张 3:4 竖图。
